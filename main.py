...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_epochs',help='Number of updates in the policy evaluation',type=int,default=1)
    parser.add_argument('--slow_lr', help='actor network learning rate',type=float, default=0.01)
    parser.add_argument('--fast_lr', help='critic network learning rate',type=float, default=0.05)
